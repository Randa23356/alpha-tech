...
<body class="bg-blue-900 min-h-screen">
    <nav class="bg-blue-800 text-white px-6 py-4 flex justify-between items-center">
        ...
        <div>
            <a href="<?= url('admin/dashboard') ?>" class="mr-4 hover:underline">Dashboard</a>
    ...
    : "" ?>>
        ...
        <div class="mt-8 text-center">
            <a href="
                "dashboard",
            .php" class="text-blue-700 font-semibold hover:underline">&larr; Kembali ke Dashboard Admin</a>
        </div>
    </main>
