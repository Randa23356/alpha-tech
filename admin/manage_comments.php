...
<body class="bg-gradient-to-br from-gray-50 to-blue-50 min-h-screen">
    ...
    <main class="lg:ml-64 max-w-7xl mx-auto px-6 py-10">
                        ...
                        <div class="flex items-start justify-between mb-4">
                            <div class="flex-1">
                                <div class="flex items-center gap-3 mb-2">
                                    ...
                                    <div>
                                        <p class="font-bold text-gray-900"><?= htmlspecialchars(
                                            $comment["username"] ?? "Anonim",
                                        ) ?></p>
                                        <p class="text-sm text-gray-500">pada: <span class="font-medium text-blue-900"><?= htmlspecialchars(
                                            $comment["title"] ?? "-",
                                        ) ?></span></p>
                                    </div>
                                </div>
                            ...
                            <form action="" method="POST">
                                ...
                                <button type="submit" name="action" value="delete" class="inline-flex items-center gap-2 bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 transition font-medium" onclick="return confirm('Hapus komentar ini?')">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="mt-8 text-center">
            <a href="
                dashboard.php",
             class="inline-flex items-center gap-2 text-blue-900 font-semibold hover:text-blue-700 transition">
