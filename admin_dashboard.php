...
<body class="bg-gradient-to-br from-gray-50 to-blue-50 min-h-screen">
    ...
    <main class="max-w-6xl mx-auto px-6 py-10">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8">
            ...
            <a href="<?= url('admin/posts') ?>" class="block bg-gradient-to-br from-blue-900 to-blue-800 text-white px-6 py-6 rounded-xl font-semibold hover:shadow-xl transition text-center">
            ...
            <a href="<?= url('admin/posts') ?>" class="block bg-white border-2 border-blue-900 text-blue-900 px-6 py-6 rounded-xl font-semibold hover:bg-blue-50 transition text-center">
                <svg class="w-12 h-12 mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                </svg>
                Kelola Postingan
            </a>
            <a href="<?= url('admin/announcements') ?>" class="block bg-white border-2 border-blue-900 text-blue-900 px-6 py-6 rounded-xl font-semibold hover:bg-blue-50 transition text-center">
                <svg class="w-12 h-12 mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z"/>
                </svg>
                Kelola Pengumuman
            </a>
            <a href="<?= url('admin/comments') ?>" class="block bg-white border-2 border-blue-900 text-blue-900 px-6 py-6 rounded-xl font-semibold hover:bg-blue-50 transition text-center">
                <svg class="w-12 h-12 mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z"/>
                </svg>
                Kelola Komentar
            </a>
            <a href="<?= url('admin/gallery') ?>" class="block bg-white border-2 border-blue-900 text-blue-900 px-6 py-6 rounded-xl font-semibold hover:bg-blue-50 transition text-center">
                <svg class="w-12 h-12 mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                </svg>
                Kelola Galeri
            </a>
            <a href="<?= url('admin/users') ?>" class="block bg-white border-2 border-blue-900 text-blue-900 px-6 py-6 rounded-xl font-semibold hover:bg-blue-50 transition text-center">
                <svg class="w-12 h-12 mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/>
                </svg>
                Kelola User
            </a>
            <a href="<?= url('admin/settings') ?>" class="block bg-white border-2 border-blue-900 text-blue-900 px-6 py-6 rounded-xl font-semibold hover:bg-blue-50 transition text-center">
                <svg class="w-12 h-12 mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
