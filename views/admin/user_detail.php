...
<body class="bg-blue-900 min-h-screen">
    <nav class="bg-blue-800 text-white px-6 py-4 flex justify-between items-center">
        ...
        <div>
            <a href="/admin/manage_users.php" class="mr-4 hover:underline">Kelola User</a>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <?php foreach ($gallery as $item): ?>
                        <div class="bg-blue-50 rounded-lg shadow p-4 flex flex-col">
                            <img src="/<?= htmlspecialchars($item["image"]) ?>" alt="Foto Galeri" class="h-32 w-full object-cover rounded mb-2">
...
..                        </div>
        ...
        <div class="mt-8 text-center">
            <a href="manage_users.php" class="text-blue-700 font-semibold hover:underline">&larr; Kembali ke Kelola User</a>
        </div>
    </main>
